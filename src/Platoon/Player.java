...
public class Player {
    ...
    public void setAiArmy(Army aiArmy) {
        this.aiArmy = aiArmy;
    }
    ...
    public void setHands(ArrayList<ArrayList<Card>> hands) {
        this.hands = hands;
    }

    public ArrayList<Army> getSelected() {
        return selected;
    }

    public void setSelected(ArrayList<Army> selected) {
        this.selected = selected;
    }

    ArrayList<Army> selected = new ArrayList<>();
